...
else
{
  ...
  $devashibhai_list_query = "SELECT * FROM devashibhai ORDER BY id DESC";
  $devashibhai_list_data = mysqli_query($conn,$devashibhai_list_query);
  $cnt=1;
?>
<!-- Top Section Start -->
              ...
              <div class="card-body pr-2 pl-2">
                <table id="example" class="display" style="width:100%">
                  <thead>
                    <tr>
                      <th>ક્રમ</th>
                      <th>રકમ આપનાર સભ્યનું નામ</th>
                      <th>રકમ આપ્યાની વિગત</th>
                      <th>આપેલી રકમ</th>
                  ...
                  <tbody>
                    <?php   // LOOP TILL END OF DATA
                      while( $devashibhai_list_result = mysqli_fetch_assoc($devashibhai_list_data))
                      {
                    ?>
                    <tr>
                      <td><?php echo $cnt;?></td>
                      <td><?php echo $devashibhai_list_result['name'];?></td>
                      <td><?php echo $devashibhai_list_result['description'];?></td>
                      <td><?php echo $devashibhai_list_result['amount'];?></td>
                      <td><?php echo $devashibhai_list_result['amount_date'];?></td>
                        ...
                        <div class="dropdown ml-auto">
                          ...
                          <ul class="dropdown-menu dropdown-menu-right">
                            <li class="dropdown-item">
                              ...
                              <a href="delete_devashibhai.php?id=<?php echo $devashibhai_list_result['id'];?>" onclick="javascript:confirmationDelete($(this));return false;">
                                Remove Game
                              </a>
                            </li>
                            <li class="dropdown-item">
                              <i class="fa fa-pencil text-primary mr-2"></i>
                              <a href="update_devashibhai.php?id=<?php echo $devashibhai_list_result['id'];?>">
                                Update Record
                              </a>
                            </li>
                          </ul>
