...
else
{
  ...
  $vadi_income_list_query = "SELECT * FROM vadi_income ORDER BY id DESC";
  $vadi_income_list_data = mysqli_query($conn,$vadi_income_list_query);
  $cnt=1;
?>
<!-- Top Section Start -->
                ...
                <table id="example" class="display" style="width:100%">
                  ...
                  <tbody>
                    <?php   // LOOP TILL END OF DATA
                      while( $vadi_income_list_result = mysqli_fetch_assoc($vadi_income_list_data))
                      {
                    ?>
                    <tr>
                      <td><?php echo $cnt;?></td>
                      <td><?php echo $vadi_income_list_result['sleep_no'];?></td>
                      <td><?php echo $vadi_income_list_result['party_name'];?></td>
                      <td><?php echo $vadi_income_list_result['function_name'];?></td>
                      <td><?php echo $vadi_income_list_result['total_amount'];?></td>
                      <td><?php echo $vadi_income_list_result['payment_date'];?></td>
                      <td>
                        <div class="dropdown ml-auto">
                          ...
                          <ul class="dropdown-menu dropdown-menu-right">
                            <li class="dropdown-item">
                              ...
                              <a href="delete_vadi_income.php?id=<?php echo $vadi_income_list_result['id'];?>" onclick="javascript:confirmationDelete($(this));return false;">
                                Remove Game
                              </a>
                            </li>
                            <li class="dropdown-item">
                              <i class="fa fa-pencil text-primary mr-2"></i>
                              <a href="update_vadi_income.php?id=<?php echo $vadi_income_list_result['id'];?>">
                                Update Record
                              </a>
                            </li>
                          </ul>
