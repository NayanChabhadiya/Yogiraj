...
else
{
  ...
  $m_list_query = "SELECT * FROM maintenance ORDER BY id DESC";
  $m_list_data = mysqli_query($conn,$m_list_query);
  $cnt=1;
?>
<!-- Top Section Start -->
                ...
                <table id="example" class="display" style="width:100%">
                  ...
                  <tbody>
                    <?php   // LOOP TILL END OF DATA
                      while( $m_list_result = mysqli_fetch_assoc($m_list_data))
                      {
                    ?>
                    <tr>
                      <td><?php echo $cnt;?></td>
                      <td><?php echo $m_list_result['name'];?></td>
                      <td><?php echo $m_list_result['mobile_no'];?></td>
                      <td><?php echo $m_list_result['date'];?></td>
                      <td><?php echo $m_list_result['section'];?></td>
                      <td><?php echo $m_list_result['home_no'];?></td>
                      <td><?php echo $m_list_result['line_no'];?></td>
                      <td><?php echo $m_list_result['g'];?></td>
                      <td><?php echo $m_list_result['1'];?></td>
                      <td><?php echo $m_list_result['2'];?></td>
                      <td><?php echo $m_list_result['date_from'];?></td>
                      <td><?php echo $m_list_result['date_to'];?></td>
                      <td><?php echo $m_list_result['total_amount'];?></td>
                      <td>
                        <div class="dropdown ml-auto">
                          ...
                          <ul class="dropdown-menu dropdown-menu-right">
                            <li class="dropdown-item">
                              ...
                              <a href="delete_maintenance.php?id=<?php echo $m_list_result['id'];?>" onclick="javascript:confirmationDelete($(this));return false;">
                                Remove Game
                              </a>
                            </li>
                            <li class="dropdown-item">
                              <i class="fa fa-pencil text-primary mr-2"></i>
                              <a href="update_maintenance.php?id=<?php echo $m_list_result['id'];?>">
                                Update Record
                              </a>
                            </li>
                          </ul>
