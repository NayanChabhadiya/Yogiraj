...
else
{
  ...
  $vadi_booking_list_query = "SELECT * FROM vadi_booking ORDER BY id DESC";
  $vadi_booking_list_data = mysqli_query($conn,$vadi_booking_list_query);
  $cnt=1;
?>
<!-- Top Section Start -->
                ...
                <table id="example" class="display" style="width:100%">
                  <thead>
                    <tr>
                      ...
                      <th>પ્રસંગ નામ</th>
                      <th>પ્રસંગ સમય</th>
                      <th>પ્રસંગ ભાડાની ડિપોજીટ</th>
                      <th></th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php   // LOOP TILL END OF DATA
                      while( $vadi_booking_list_result = mysqli_fetch_assoc($vadi_booking_list_data))
                      {
                    ?>
                    <tr>
                      <td><?php echo $cnt;?></td>

                      <td><?php echo $vadi_booking_list_result['party_name'];?></td>
                      <td><?php echo $vadi_booking_list_result['address'];?></td>
                      <td><?php echo $vadi_booking_list_result['mobile_no'];?></td>
                      <td><?php echo $vadi_booking_list_result['function_date'];?></td>
                      <td><?php echo $vadi_booking_list_result['function_name'];?></td>
                      <td><?php echo $vadi_booking_list_result['function_time'];?></td>
                      <td><?php echo $vadi_booking_list_result['function_deposit'];?></td>
                      <td>
                        <div class="dropdown ml-auto">
                          ...
                          <ul class="dropdown-menu dropdown-menu-right">
                            <li class="dropdown-item">
                              ...
                              <a href="delete_vadi_booking.php?id=<?php echo $vadi_booking_list_result['id'];?>" onclick="javascript:confirmationDelete($(this));return false;">
                                Remove Game
                              </a>
                            </li>
                            <li class="dropdown-item">
                              <i class="fa fa-pencil text-primary mr-2"></i>
                              <a href="update_vadi_booking.php?id=<?php echo $vadi_booking_list_result['id'];?>">
                                Update Record
                              </a>
                            </li>
                          </ul>
