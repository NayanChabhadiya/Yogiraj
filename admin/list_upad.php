...
else
{
  ...
  $upad_list_query = "SELECT * FROM upad ORDER BY id DESC";
  $upad_list_data = mysqli_query($conn,$upad_list_query);
  $cnt=1;
?>
<!-- Top Section Start -->
                ...
                <table id="example" class="display" style="width:100%">
                  ...
                  <tbody>
                    <?php   // LOOP TILL END OF DATA
                      while( $upad_list_result = mysqli_fetch_assoc($upad_list_data))
                      {
                    ?>
                    <tr>
                      <td><?php echo $cnt;?></td>
                      <td><?php echo $upad_list_result['name'];?></td>
                      <td><?php echo $upad_list_result['description'];?></td>
                      <td><?php echo $upad_list_result['amount'];?></td>
                      <td><?php echo $upad_list_result['upad_date'];?></td>
                      <td>
                        <div class="dropdown ml-auto">
                          ...
                          <ul class="dropdown-menu dropdown-menu-right">
                            <li class="dropdown-item">
                              ...
                              <a href="delete_upad.php?id=<?php echo $upad_list_result['id'];?>" onclick="javascript:confirmationDelete($(this));return false;">
                                Remove Game
                              </a>
                            </li>
                            <li class="dropdown-item">
                              <i class="fa fa-pencil text-primary mr-2"></i>
                              <a href="update_upad.php?id=<?php echo $upad_list_result['id'];?>">
                                Update Record
                              </a>
                            </li>
                          </ul>
