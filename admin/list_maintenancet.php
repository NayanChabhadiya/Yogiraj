...
else
{
  ...
  $mt_list_query = "SELECT * FROM maintenancet ORDER BY id DESC";
  $mt_list_data = mysqli_query($conn,$mt_list_query);
  $cnt=1;
?>
<!-- Top Section Start -->
                ...
                <table id="example" class="display" style="width:100%">
                  ...
                  <tbody>
                    <?php   // LOOP TILL END OF DATA
                      while( $mt_list_result = mysqli_fetch_assoc($mt_list_data))
                      {
                    ?>
                    <tr>
                      <td><?php echo $cnt;?></td>
                      <td><?php echo $mt_list_result['date'];?></td>
                      <td><?php echo $mt_list_result['section'];?></td>
                      <td><?php echo $mt_list_result['line_no'];?></td>
                      <td><?php echo $mt_list_result['home_no_from'];?></td>
                      <td><?php echo $mt_list_result['home_no_to'];?></td>
                      <td><?php echo $mt_list_result['home_no_from1'];?></td>
                      <td><?php echo $mt_list_result['home_no_to1'];?></td>
                      <td><?php echo $mt_list_result['from_date'];?></td>
                      <td><?php echo $mt_list_result['to_date'];?></td>
                      <td><?php echo $mt_list_result['amount'];?></td>
                      <td><?php echo $mt_list_result['description'];?></td>
                      <td>
                        <div class="dropdown ml-auto">
                          ...
                          <ul class="dropdown-menu dropdown-menu-right">
                            <li class="dropdown-item">
                              ...
                              <a href="delete_maintenancet.php?id=<?php echo $mt_list_result['id'];?>" onclick="javascript:confirmationDelete($(this));return false;">
                                Remove Game
                              </a>
                            </li>
                            <li class="dropdown-item">
                              <i class="fa fa-pencil text-primary mr-2"></i>
                              <a href="update_maintenancet.php?id=<?php echo $mt_list_result['id'];?>">
                                Update Record
                              </a>
                            </li>
                          </ul>
